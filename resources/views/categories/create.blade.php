                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="translations[en][name]" name="translations[en][name]" class="form-control @error('translations.en.name') is-invalid @enderror" value="{{ old('translations.en.name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="translations[ar][name]" name="translations[ar][name]" class="form-control @error('translations.ar.name') is-invalid @enderror" value="{{ old('translations.ar.name') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-3">
                            <div id="image-container" style="display: flex; gap: 10px; flex-wrap: wrap;">
                                <!-- Preview images and delete buttons will be inserted here -->
                            </div>
                        </div>
                    </div>
